...
function OpenMainMenu()
	...
	function chooseSite:DoClick()
		gui.OpenURL("http://steamcommunity.com/groups/CultOfV92")
	end
...
function ChooseSkillsTab(frame, scroll)
    ...
    function skills:LayoutInfo(skillTable)
        ...
        for level,description in pairs(skillTable.LevelDescription) do
        ...
        levels:SetSize(widestdesc+4 , (draw.GetFontHeight("UiBold")+4)*table.Count(skillTable.LevelDescription))
