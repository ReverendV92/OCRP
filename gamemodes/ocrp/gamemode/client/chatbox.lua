...
GM.Chat["OOC"] = {
	["Text"] = "(OOC) " ,
	["ChatColor"] = Color( 255 , 255 , 255 , 255 ) ,
}
GM.Chat["LOOC"] = {
	["Text"] = "(LOOC) " ,
	["ChatColor"] = Color( 190 , 190 , 190 , 255 ) ,
}
GM.Chat["Yell"] = {
	["Text"] = "(Yell) " ,
	["ChatColor"] = Color( 255 , 165 , 0 , 255 ) ,
}
GM.Chat["Local"] = {
	["Text"] = "(Local) " ,
	["ChatColor"] = Color( 255 , 243 , 169 , 255 ) , 
}
GM.Chat["Emote"] = {
	["Text"] = "(Emote) " ,
	["ChatColor"] = Color( 210 , 30 , 30 , 255 ) ,
	["NameColor"] = Color( 210 , 30 , 30 , 255 ) ,
}
GM.Chat["Whisper"] = {
	["Text"] = "(Whisper) " ,
	["ChatColor"] = Color( 215 , 255 , 222 , 255 ) ,
}
GM.Chat["911"] = {
	["Text"] = "(911) " ,
	["ChatColor"] = Color( 255 , 30 , 30 , 255 ) ,
	["NameColor"] = Color( 255 , 30 , 30 , 255 ) ,
}
GM.Chat["Broadcast"] = {
	["Text"] = "(Broadcast) " ,
	["ChatColor"] = Color( 255 , 30 , 30 , 255 ) ,
...
GM.Chat["Gov Radio"] = {
	["Text"] = "(Radio) " ,
	["ChatColor"] = Color( 90 , 204 , 255 , 255 ) ,
}
GM.Chat["Advert"] = {
	["Text"] = "(Advert) " ,
	["ChatColor"] = Color( 255 , 255 , 255 , 255 ) ,
...
GM.Chat["PM"] = {
	["Text"] = "(PM) " ,
	["ChatColor"] = Color( 0 , 220 , 20 , 255 ) ,
}
GM.Chat["Org"] = {
	["Text"] = "(Org) " ,
	["ChatColor"] = Color( 0 , 255 , 255 , 255 ) ,
}
GM.Chat["To Admins"] = {
	["Text"] = " (ToAdmins) " , 
	["ChatColor"] = Color( 69 , 185 , 255 , 255 ) , 
	["NameColor"] = Color( 69 , 185 , 255 , 255 ) ,
}

function ChatBoxInit( )

	if OCRP_CHATBOX and IsValid( OCRP_CHATBOX ) then 
...
function GM:FinishChat( )
    ...
    if not OCRP_CHATBOX or not OCRP_CHATBOX:IsValid( ) then 
	...
	if OCRP_CHATBOX.label and OCRP_CHATBOX.label:IsValid( ) then 

		OCRP_CHATBOX.label:Remove( ) 

	end

	if OCRP_CHATBOX.textbox and OCRP_CHATBOX.textbox:IsValid() then

		OCRP_CHATBOX.textbox:Remove() 
