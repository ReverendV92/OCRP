...
function GUI_ChiefMenu()
	if LocalPlayer():GetNWBool("Handcuffed") or LocalPlayer():Team() != CLASS_CHIEF then return end
...
function GUI_Rebuild_Police_Locker(parent)
	...
	GUI_Max_p228_Ammo_Out:SetText("Max 9x19mm Ammo per officer:")
	...
	GUI_Max_p228_Ammo_Out.ValueChanged = function()
		...
		net.WriteString("item_ammo_9x19mm")
	...
	GUI_Max_ump_Ammo_Out:SetText("Max 5.56x45mm Ammo per officer:")
	GUI_Max_ump_Ammo_Out:SetMin(30)
	GUI_Max_ump_Ammo_Out:SetValue(GAMEMODE.CL_Police_Max_Ump)
	GUI_Max_ump_Ammo_Out:SetMax(150)
	GUI_Max_ump_Ammo_Out:SetDecimals(0)
	
	GUI_Max_ump_Ammo_Out.ValueChanged = function()
		net.Start("OCRP_PoliceMax_Update")
		net.WriteString("item_ammo_556x45")
...
function GUI_Amount_Popup_Chief(item)
	if GUI_Amount_Frame != nil and GUI_Amount_Frame:IsValid() then GUI_Amount_Frame:Remove() end
...
function GUI_Rebuild_Police_Ply(parent)
	...
	for _,ply in pairs(player.GetAll()) do
		if ply != LocalPlayer() then 
			if ply:Team() == CLASS_POLICE or ply:Team() == CLASS_SWAT then
