...
-- ocrpdb = mysqloo.connect("127.0.0.1" , "jessevan_master" , "wN;U_xzVxxm9Md(R8I" , "jessevan_OCRP" , 3306)
ocrpdb = mysqloo.connect("jessevanover92.net" , "jessevan_master" , "wN;U_xzVxxm9Md(R8I" , "jessevan_OCRP" , 3306)
...
function PushSQLData()
    ...
    for id,t in pairs(GAMEMODE.DisconnectSaves) do
        ...
        if t["wallet"] == nil or t["wallet"] == "" then continue end -- Above line didn't fix it. I'm hoping this will. Wallet should never be nil or "" , at the very least it's 0.
        for _,column in pairs(columns) do
