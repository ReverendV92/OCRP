...
function GM:ShowSpare1( ply )
	...
	if tr.HitNonWorld then
		if tr.Entity:GetClass() == "prop_ragdoll" and tr.Entity.player != nil and tr.Entity:GetPos():Distance(ply:GetPos()) <= 100 then
			if ply:Team() == CLASS_CITIZEN and tr.Entity.player:IsValid() and tr.Entity.player:Team() == CLASS_CITIZEN then	
...
function Craft_CraftItem(ply,recipe)
    local craftTable = GAMEMODE.OCRP_Recipes[recipe]
