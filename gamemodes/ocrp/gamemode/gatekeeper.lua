...
require("gatekeeper")
 ...
 local pass_new = CreateConVar("sv_password_new" , "" , FCVAR_PROTECTED )  
   
 -- The cvar that will make room for a client if they attempt to join  
 local pass_makeroom = CreateConVar("sv_password_makeroom" , "" , FCVAR_PROTECTED )  
...
local Allowed_Players_SteamId = {
	...
	"STEAM_0:1:18976388" , -- Reverend V92
	"STEAM_0:0:26749325" , -- Scoot
} 
