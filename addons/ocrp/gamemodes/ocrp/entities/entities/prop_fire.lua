...
ENT.Author = "OCRP"
ENT.Contact = "V92"
ENT.Purpose = "Is something burning?"
ENT.Instructions = "Snap Crackle Pop, Flashover Point"
ENT.Category = "OCRP"
...
if SERVER then
	...
	function ENT:Think ( )
		...
		if IsOutdoors then
			if SW.WeatherMode == "storm" or SW.WeatherMode == "rain" then
			...
			elseif SW.WeatherMode == "snow" or SW.WeatherMode == "blizzard" then
