...
function CL_UpdateProf( umsg )
	...
	if GUI_Main_Frame != nil and GUI_Main_Frame:IsValid() then
...
function GUI_Rebuild_Professions(parent)
	...
	if activeprof == nil then
		...
		for Prof,data in pairs(OCRP_Professions or {} ) do	
	...
	elseif activeprof == "Pro_Crafting" then
		...
		GUI_Prof_Name:SetParent(GUI_Prof_Panel_List)
												...
												for _,data in pairs(GAMEMODE.OCRP_Professions["Pro_Crafting"].Recipes) do
														...
														if data.Amount != nil and data.Amount > 1 then
														...
														if data.HeatSource != nil and data.HeatSource then
														...
														elseif data.WaterSource != nil and data.WaterSource then
														...
														elseif data.Explosive != nil and data.Explosive then
														...
														for k,reqitem in pairs(data.Requirements) do
															...
															GUI_Craft_Item_Craft.Paint = function()																		
																																				if OCRP_Professions[activeprof].Exp.Skill >= data.XPRequired.Skill and OCRP_Professions[activeprof].Exp.Mechanical >= data.XPRequired.Mechanical and OCRP_Professions[activeprof].Exp.Practical >= data.XPRequired.Practical then 
