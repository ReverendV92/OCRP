local rockfordv2b_carlot_display = {

	{
		["Position"] = Vector( -3392 , -831 , 80 ) ,
		["Ang"] = Angle( 0 , -144 , 0 ) ,
		["Model"] = "models/tdmcars/dod_challenger70.mdl" ,
	} ,

	{
		["Position"] = Vector( -5379 , -470 , 64 ) ,
		["Ang"] = Angle( 0 , -50 , 0 ) ,
		["Model"] = "models/tdmcars/for_mustanggt.mdl" ,
	} ,

	{
		["Position"] = Vector( -5346 , -884 , 64 ) ,
		["Ang"] = Angle( 0 , 0 , 0 ) ,
		["Model"] = "models/tdmcars/aud_rs4avant.mdl" ,
	} ,

	{
		["Position"] = Vector( -6135 , -472 , 64 ) ,
		["Ang"] = Angle( 0 , -130 , 0 ) ,
		["Model"] = "models/tdmcars/nissan_gtr.mdl" ,
	} ,

	{
		["Position"] = Vector( -5790 , -805 , 64 ) ,
		["Ang"] = Angle( 0 , -130 , 0 ) ,
		["Model"] = "models/tdmcars/por_918.mdl" ,
	} ,

	{
		["Position"] = Vector( -2869 , -1256 , 64 ) ,
		["Ang"] = Angle( 0 , -122 , 0 ) ,
		["Model"] = "models/tdmcars/landrover12.mdl" ,
	} ,

	{
		["Position"] = Vector( -2869 , -1473 , 64 ) ,
		["Ang"] = Angle( 0 , -122 , 0 ) ,
	...
	{
		["Position"] = Vector( -2869 , -1596 , 64 ) ,
		["Ang"] = Angle( 0 , -122 , 0 ) ,
		["Model"] = "models/tdmcars/gmc_c5500.mdl" ,
	} ,

	{
		["Position"] = Vector( -3058 , -1843 , 64 ) ,
		["Ang"] = Angle( 0 , -90 , 0 ) ,
		["Model"] = "models/tdmcars/dod_charger12.mdl" ,
	} ,

	{
		["Position"] = Vector( -3173 , -1843 , 64 ) ,
		["Ang"] = Angle( 0 , -90 , 0 ) ,
		["Model"] = "models/tdmcars/ford_coupe_40.mdl" ,
	} ,

	{
		["Position"] = Vector( -3294 , -1255 , 64 ) ,
		["Ang"] = Angle( 0 , 137 , 0 ) ,
...
function SpawnCarPlaces()
	for k,v in pairs(rockfordv2b_carlot_display) do
