...
function GM:Think( ) 
	if OCRP_WorldData.TimeNextSecond <= CurTime() then
		...
		if IsDay() then
			...
			col.a = 0 
			if OCRP_WorldData.Time >= OCRP_WorldData.Dawn.Start and OCRP_WorldData.Time < OCRP_WorldData.Dawn.End then	
			...
			elseif OCRP_WorldData.Time >= OCRP_WorldData.Dusk.Start and OCRP_WorldData.Time < OCRP_WorldData.Dusk.End then
		...
		if OCRP_WorldData.Time > OCRP_WorldData.DayLength or OCRP_WorldData.Time < 0 then
			OCRP_WorldData.Time = 0
		end
		...
		if OCRP_WorldData.NextTime <= CurTime() then 
			if OCRP_WorldData.Time >= (OCRP_WorldData.Dawn.Start+(OCRP_WorldData.Dawn.End-OCRP_WorldData.Dawn.Start)/4) and OCRP_WorldData.Time < OCRP_WorldData.DayLength/2 then	
			...
			elseif OCRP_WorldData.Time >= OCRP_WorldData.DayLength/2 and OCRP_WorldData.Time < OCRP_WorldData.Dusk.End then	
...
function IsDay()
	if OCRP_WorldData.Time >= OCRP_WorldData.Dawn.Start and OCRP_WorldData.Time < OCRP_WorldData.Dusk.End then 
		return true
	end
	return false
end
...
function IsDusk()
	if OCRP_WorldData.Time >= OCRP_WorldData.Dusk.Start and OCRP_WorldData.Time < OCRP_WorldData.Dusk.End then
		return true
	end
	return false
end
...
function daylight:think( )
	// not ready to think?
	if ( !self.ready or self.nextthink > CurTime( ) ) then return; end
