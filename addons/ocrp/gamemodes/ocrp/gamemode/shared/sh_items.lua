...
GM.OCRP_Items["item_bodyarmor01"] = {
	...
	["Model"] = "models/dynamicrp/items/kevlar_vest.mdl" ,-- The model
	["Price"] = 500 ,--Price
	["Weight"] = 1 ,
	["Max"] = 5 ,-- Total Number of items able to be carried.
	-- what it does don't touch it.
...
GM.OCRP_Items["item_taser_cop"] = {
	...
	["DoesntSave"] = true ,
	["Weapondata"] = {
		["Weapon"] = "weapon_cop_taser" ,DontDisplay = true ,
...
GM.OCRP_Items["item_ammo_38s"] = {
	["Name"] = ".38 Special Ammo" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Small-caliber revolver rounds" ,-- The description
...
GM.OCRP_Items["item_ammo_9x19mm"] = {
	["Name"] = "9x19mm Ammo" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Standard NATO pistol rounds" ,-- The description
	["Model"] = "models/items/boxsrounds.mdl" ,-- The model
	["Price"] = 20 ,--Price
	["Weight"] = 0 ,
	["AmmoType"] = "9x19mm_fmj" ,
...
GM.OCRP_Items["item_ammo_45acp"] = {
	["Name"] = ".45 ACP Ammo" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = ".45 ACP rounds" ,-- The description
	["Model"] = "models/items/boxsrounds.mdl" ,-- The model
	["Price"] = 20 ,--Price
	["Weight"] = 0 ,
	["AmmoType"] = "45acp" ,
...
GM.OCRP_Items["item_ammo_556x45"] = {
	["Name"] = "5.56x45mm Ammo" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Standard NATO rifle rounds" ,-- The description
	["Model"] = "models/items/boxmrounds.mdl" ,-- The model
	["Price"] = 20 ,--Price
	["Weight"] = 0 ,
	["AmmoType"] = "556x45mmnato" ,
	-- what it does don't touch it.
	["DoesntSave"] = true ,
	["Condition"] = function(ply,item) -- Checks to see if the player can use it.
					return true
...
GM.OCRP_Items["item_ammo_762x39"] = {
	["Name"] = "7.62x39mm Ammo" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Warsaw Pact rifle rounds" ,-- The description
	["Model"] = "models/items/boxmrounds.mdl" ,-- The model
	["Price"] = 20 ,--Price
	["Weight"] = 0 ,
	["AmmoType"] = "762x39mmwp" ,
...
GM.OCRP_Items["item_ammo_12gauge"] = {
	["Name"] = "12-Gauge Ammo" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Standard 00-buckshot" ,-- The description
...
GM.OCRP_Items["item_detspec"] = {
	["Name"] = "Detective Special" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Cheap revolver, uses .38 Special" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/detspec_w.mdl" ,-- The model
	["Price"] = 150 ,--Price
	["Weight"] = 2 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		["Weapon"] = "v92_heat_detspec" ,
		["Setup"] = function(ply,item) 
		end ,
		["Bone"] =  "ValveBiped.Bip01_Pelvis" ,
		["Angle"] = Angle(90 ,10 ,90),
		["Pos"] =  function(obj)
					local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_detspec"].Weapondata.Bone)
...
GM.OCRP_Items["item_92fs"] = {
	["Name"] = "92FS" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Cheap and reliable handgun, uses 9x19mm NATO" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/92fs_w.mdl" ,-- The model
	["Price"] = 400 ,--Price
	["Weight"] = 3 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		["Weapon"] = "v92_heat_92fs" ,
		["Setup"] = function(ply,item) 
		end ,
		["Bone"] =  "ValveBiped.Bip01_Pelvis" ,
		["Angle"] = Angle(90 ,10 ,90),
		["Pos"] =  function(obj)
					local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_92fs"].Weapondata.Bone)
					local pos,ang = obj:GetBonePosition( leg )
					return ang:Forward() * 5 + ang:Up() * 4
			end ,
		} ,
...
GM.OCRP_Items["item_p220"] = {
	["Name"] = "P220" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Semi-automatic handgun, Uses .45 ACP" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/p220_w.mdl" ,-- The model
	["Price"] = 520 ,--Price
	["Weight"] = 5 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		["Weapon"] = "v92_heat_p220" ,
		["Setup"] = function(ply,item) 
		end ,
		["Bone"] =  "ValveBiped.Bip01_Pelvis" ,
		["Angle"] = Angle(90 ,-10 ,90),
		["Pos"] =  function(obj)
					local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_p220"].Weapondata.Bone)
					local pos,ang = obj:GetBonePosition( leg )
...
GM.OCRP_Items["item_1911"] = {
	["Name"] = "M1991A1" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Strong and accurate, Uses .45 ACP" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/officer_w.mdl" ,-- The model
	["Price"] = 760 ,--Price
	["Weight"] = 7 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		["Weapon"] = "v92_heat_officer" ,
		["Setup"] = function(ply,item) end ,
		["Bone"] =  "ValveBiped.Bip01_R_Thigh" ,
		["Angle"] = Angle(0 ,0 ,90),
		["Pos"] =  function(obj)
			local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_1911"].Weapondata.Bone)
			local pos,ang = obj:GetBonePosition( leg )
...
GM.OCRP_Items["item_megastar"] = {
	["Name"] = "Dual Megastars" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Spray and Pray, Uses .45 ACP" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/megastar_w.mdl" ,-- The model
	["Price"] = 1000 ,--Price
	["Weight"] = 7 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		["Weapon"] = "v92_heat_megastar" ,
		["Setup"] = function(ply,item) end ,
		["Bone"] =  "ValveBiped.Bip01_R_Thigh" ,
		["Angle"] = Angle(0 ,0 ,90),
		["Pos"] =  function(obj)
			local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_megastar"].Weapondata.Bone)
			local pos,ang = obj:GetBonePosition( leg )
			return ang:Up() * -3 + ang:Forward() * 3 
		end ,
	} ,
...
GM.OCRP_Items["item_tmp"] = {
	["Name"] = "TMP" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "High recoil, low accuracy, rapid fire-rate, Uses 9x19mm NATO" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/tmp_w.mdl" ,-- The model
	["Price"] = 960 ,--Price
	["Weight"] = 10 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		...
		["Angle"] = Angle(0 ,0 ,90),
		["Pos"] =  function(obj) 
					local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_tmp"].Weapondata.Bone)
					local pos,ang = obj:GetBonePosition( leg )
...
GM.OCRP_Items["item_mp5a3"] = {
	["Name"] = "MP5A3" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Medium sized sub machine gun, Uses 9x19mm NATO" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/mp5a3_w.mdl" ,-- The model
	["Price"] = 800 ,--Price
	["Weight"] = 10 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		["Weapon"] = "v92_heat_mp5a3" ,
		["Setup"] = function(ply,item) 
			end ,
			["Bone"] =  "ValveBiped.Bip01_Spine4" ,
			["Angle"] = Angle(-50 ,90 ,90),
			["Pos"] =  function(obj) 
					local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_mp5a3"].Weapondata.Bone)
					local pos,ang = obj:GetBonePosition( leg )
...
GM.OCRP_Items["item_m733"] = {
	["Name"] = "Model 733" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "High damage, accurate, rapid fire-rate, Uses 5.56x45mm NATO" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/car15_w.mdl" ,-- The model
	["Price"] = 1400 ,--Price
	["Weight"] = 10 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		["Weapon"] = "v92_heat_car15" ,
		["Setup"] = function(ply,item) 
			end ,
			["Bone"] =  "ValveBiped.Bip01_Spine4" ,
			["Angle"] = Angle(-30 ,90 ,90),
			["Pos"] =  function(obj) 
					local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_m733"].Weapondata.Bone)
					local pos,ang = obj:GetBonePosition( leg )
...
GM.OCRP_Items["item_m16a1"] = {
	["Name"] = "M16A1" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "High damage, accurate, rapid fire-rate, Uses 5.56x45mm NATO" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/m16a1_w.mdl" ,-- The model
	["Price"] = 1360 ,--Price
	["Weight"] = 10 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		["Weapon"] = "v92_heat_m16a1" ,
		["Setup"] = function(ply,item) 
			end ,
			["Bone"] =  "ValveBiped.Bip01_Spine4" ,
			["Angle"] = Angle(-30 ,90 ,90),
			["Pos"] =  function(obj) 
					local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_m16a1"].Weapondata.Bone)
					local pos,ang = obj:GetBonePosition( leg )
					return  ang:Forward() * -10 + ang:Up() * 4
				end ,
			} ,
...
GM.OCRP_Items["item_type561"] = {
	["Name"] = "Type 56-1" ,-- The Name
	["Angle"] = Angle(90 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "High damage, accurate, medium fire-rate, Uses 7.62x39mm Warsaw Pact" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/type561_w.mdl" ,-- The model
	["Price"] = 1200 ,--Price
	["Weight"] = 10 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		["Weapon"] = "v92_heat_t561" ,
		["Setup"] = function(ply,item) 
			end ,
			["Bone"] =  "ValveBiped.Bip01_Spine4" ,
			["Angle"] = Angle(10 ,90 ,90),
			["Pos"] =  function(obj) 
					local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_type561"].Weapondata.Bone)
					local pos,ang = obj:GetBonePosition( leg )
...
GM.OCRP_Items["item_m870"] = {
	["Name"] = "Model 870" ,-- The Name
	["Angle"] = Angle(120 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Great for high damage at short range, Uses 12-Gauge Buckshot" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/m870_wood_w.mdl" ,-- The model
	["Price"] = 950 ,--Price
	["Weight"] = 10 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		["Weapon"] = "v92_heat_m870w" ,
		["Setup"] = function(ply,item) 
			end ,
			["Bone"] =  "ValveBiped.Bip01_Spine4" ,
			["Angle"] = Angle(-10 ,90 ,90),
			["Pos"] =  function(obj) 
					local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_m870"].Weapondata.Bone)
					local pos,ang = obj:GetBonePosition( leg )
...
GM.OCRP_Items["item_m3s90"] = {
	["Name"] = "M3 Super 90" ,-- The Name
	["Angle"] = Angle(120 ,90 ,90),---- Allows for manual rotation on the display 
	["Desc"] = "Great for high damage at short range, Uses 12-Gauge Buckshot" ,-- The description
	["Model"] = "models/jessev92/css/weapons/heat/m3s90_w.mdl" ,-- The model
	["Price"] = 1160 ,--Price
	["Weight"] = 10 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Illegalizeable"] = true ,
	["Weapondata"] = {
		["Weapon"] = "v92_heat_m3s90" ,
		["Setup"] = function(ply,item) 
			end ,
			["Bone"] =  "ValveBiped.Bip01_Spine4" ,
			["Angle"] = Angle(-10 ,90 ,90),
			["Pos"] =  function(obj) 
					local leg = obj:LookupBone(GAMEMODE.OCRP_Items["item_m3s90"].Weapondata.Bone)
					local pos,ang = obj:GetBonePosition( leg )
					return ang:Forward() * -10 + ang:Up() * 2
				end ,
			} ,
...
GM.OCRP_Items["item_ammo_45acp"] = {
	...
	["DoesntSave"] = true ,
	["Weapondata"] = {
		["Weapon"] = "police_shotgun_ocrp" ,DontDisplay = true ,
		["Setup"] = function(ply,item) 
			end ,
			["Bone"] =  "ValveBiped.Bip01_Spine4" ,
...
function(self)
			local free = false
				for _,objs in pairs(ents.FindInSphere(self:GetPos(),64)) do
					if objs:GetClass() == "item_base" and objs:GetNWInt("Class") == "item_ladder" then
						if objs.Ladder != nil and objs.AttachedLadder == nil then
							free = true
			...
			if player.GetByID(self:GetNWInt("Owner")):OnGround() or free then
	...
	["PickupFunction"] = 
				function(self)
					if self.Ladder != nil and self.Ladder:IsValid() then
						self.Ladder:Remove()
						if self.AttachedLadder != nil and self.AttachedLadder:IsValid() then
...
GM.OCRP_Items["item_lockpick"] = {
	...
	-- what it does don't touch it.
	["Condition"] = function(ply,item) -- Checks to see if the player can use it.
					if ply:HasWeapon("ocrp_lockpick") then 
...
GM.OCRP_Items["item_wrench"] = {
	...
	-- what it does don't touch it.
	["Condition"] = function(ply,item) -- Checks to see if the player can use it.
                    if ply:HasWeapon("ocrp_wrench") then
	...
	["Function"] = 
		function(ply,item) 
			ply:Give("ocrp_wrench")
            ply:SelectWeapon("ocrp_wrench")
...
GM.OCRP_Items["item_weed_seed"] = {
	...
	["Model"] = "models/dynamicrp/items/weed_seed.mdl" ,-- The model
	["Price"] = 300 ,--Price
	["Weight"] = 0 ,
...
GM.OCRP_Items["item_door_alarm"] = {
	...
	["Condition"] = function(ply,item) -- Checks to see if the player can use it.
				...
				local tracedata = {}
				tracedata.start = pos
				tracedata.end["Pos"] =  pos+(posang*80)
				tracedata.filter = ply
				local trace = util.TraceLine(tracedata)

				if trace.HitWorld then return false end
				if trace.HitNonWorld then
					if trace.Entity:IsDoor() and trace.Entity:GetNWInt("Owner") == ply:EntIndex() and !trace.Entity.DoorAlarm then
						return true
					end
				end
				return false
...
function(self)
	...
	["PickupFunction"] = 
				function(self,activator)
					if self.OCRPData != nil and self.OCRPData["Inventory"] != nil then
...
GM.OCRP_Items["item_cell"] = {
	...
	["Model"] = "models/dynamicrp/items/cell_phone.mdl" ,-- The model
	["Price"] = 500 ,--Price
	["Weight"] = 1 ,
	["Max"] = 1 ,-- Total Number of items able to be carried.
	["Protected"] = true ,
