...
GM.OCRP_Skills["skill_conc"] = {
	...
	["LevelDescription"] = {"Accuracy with guns increased by 10%." ,"Accuracy with guns increased by 20%." ,"Accuracy with guns increased by 30%." ,"Accuracy with guns increased by 40%." ,"Accuracy with guns increased by 50%."} ,
}
...
GM.OCRP_Skills["skill_end"] = {
	...
	["LevelDescription"] = {
		"Energy Decay Reduced by 25%." ,
		"Energy Decay Reduced by 50%." ,
		"Energy Decay Reduced by 75%" ,
	} ,
...
GM.OCRP_Skills["skill_str"] = {
    ...
    ["Color"] = Color(255 ,0 ,0 ,100),
	["LevelDescription"] = {
		"Melee attack power increased by 25%." ,
		"Damage Taken reduced by 25%." ,
		"Melee attack power increased by 50%." ,
	} ,
}
...
GM.OCRP_Skills["skill_picking"] = {
	...
	["LevelDescription"] = {
		"Lockpick doors." ,
		"Lockpick success 15% more often." ,
		"Lockpick handcuffs." ,
		"Lockpick success 20% more often." ,
		"Lockpick padlocks." ,
		"Lockpick cars and large doors." ,
		"Lockpicks success 25% more often." ,
	} ,
}
...
GM.OCRP_Skills["skill_herb"] = {
	...
	["LevelDescription"] = {
		"The ability to grow weed." ,
		"10% less time to grow drugs." ,
		"20% less time to grow drugs." ,
		"30% less time to grow drugs." ,
	} ,
}
...
GM.OCRP_Skills["skill_craft_bal"] = {
	...
	["Requirements"] = {
		{
			["Skill"] = "skill_craft_basic" ,
			["level"] = 1 ,
		} ,
	} ,
	["LevelDescription"] = {
		"The ability to craft advanced weapons."
	} ,
}
...
GM.OCRP_Skills["skill_craft_circ"] = {
	...
	["LevelDescription"] = {
		"The ability to craft electronic items." ,
	} ,
}
...
GM.OCRP_Skills["skill_craft_basic"] = {
    ...
    ["Color"] = Color( 0 , 200 , 255 , 100 ) ,
	["LevelDescription"] = {
		"The ability to craft basic items."
	} ,
}
...
GM.OCRP_Skills["skill_rob"] = {
    ...
    ["Color"] = Color( 255 , 130 , 0 , 100 ) ,
	["LevelDescription"] = { 
		"Steal $100 more from mayor cash blocks." ,
...
GM.OCRP_Skills["skill_theft"] = {
    ...
    ["Color"] = Color( 255 , 130 , 0 , 100 ) ,
	["LevelDescription"] = {
		"Take merchandise from shops if the owner isn't around." ,
	} ,
}
